...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._afterDecideResponse = function (response) {
        ...
        (_d = this.surveys) === null || _d === void 0 ? void 0 : _d.afterDecideResponse(response);
    };
    ...
    PostHog.prototype.capture = function (event_name, properties, options) {
        ...
        if (!(options === null || options === void 0 ? void 0 : options.skip_client_rate_limiting) && this.rateLimiter.isCaptureClientSideRateLimited()) {
