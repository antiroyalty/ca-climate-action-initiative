...
# Didn't read the NEM2 document yet, might have updated values for Feb 15 onwards
# https://www.pge.com/tariffs/assets/pdf/tariffbook/ELEC_SCHEDS_NEM2.pdf

# System upgrade costs???
# https://www.pge.com/assets/pge/docs/about/doing-business-with-pge/NEM2A-FAQ.pdf
# Q. Who pays for distribution system upgrades?
# A. If your system is ≤1MW, PG&E pays for distribution system upgrades required
# interconnecting a NEM2A generator unless you are the only beneficiary of a required
# interconnection facility. For example, you are responsible to pay to upgrade a
# transformer if the transformer serves only your property and account(s). You will not
# pay if that transformer serves other customers. If your system is >1MW, you are
# responsible for all the upgrade costs.
